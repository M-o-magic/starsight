...
#     # args = parse_args()
#     input_json='/data/cj/valid_contest/Counting__Regional_counting.json'
#     image_root='/data/cj/valid_contest/cropped_red_regions'
#     model_dir='/data/cj/FM9G4B-V'
#     output_json='/data/cj/valid_contest/eval_Counting__Regional_counting.json'
