...
#     # args = parse_args()
#     input_json='/data/cj/valid_contest/Complex_reasoning__Route_planning.json'
#     image_root='/data/cj/valid_contest/valid_images'
#     model_dir='/data/cj/FM9G4B-V'
#     output_json='/data/cj/valid_contest/eval_Route_planning1.json'
