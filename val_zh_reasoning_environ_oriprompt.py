...
#     # args = parse_args()
#     input_json='/data/cj/RS_StarSight/src/datasets/valid/data/sub_json/environmental_condition_reasoning.json'
#     image_root='/data/cj/valid_contest/valid_images'
#     model_dir='/data/cj/FM9G4B-V'
#     output_json='/data/cj/valid_contest/environmental_condition.json'
